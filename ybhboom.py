...
# 初始化UART3，波特率115200，8位数据位，无校验，2位停止位
uart = UART(UART.UART3, baudrate=115200, bits=UART.EIGHTBITS, parity=UART.PARITY_NONE, stop=UART.STOPBITS_TWO)
...
try:
    ...
    while True:
        ...
        # 查找矩形
        rects = img.find_rects(threshold=7000)  # 调整阈值，减少误检测
        best_rect = None
        max_area = 0
